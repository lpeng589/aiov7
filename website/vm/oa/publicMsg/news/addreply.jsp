...
function isDelete(m){
	...
	　　 if(action == 'ok'){
		document.location = "/OANewsAction.do?operation=$globals.getOP("OP_DELETE")&type=deletereply&newsId=$!newsId&replyId="+m;
		}
	});
}
</script>
...
<body>
<a name="HTML_top"></a>		
<form name="form" id="form" action="/OANews.do?type=addreplyPrepare&newsId=$!newsId"  method="post">
	...
	<div>
		...
		<div class="comment_list">	
				<div class="comment_top">			
						<span onclick="openAddReply();" style="cursor: pointer;font-weight:bold;color:blue;">
						<img src="style1/images/oaimages/C_C.gif" />$text.get("I.want.reply")</span>	
				</div>
							
				<div style="overflow:hidden; overflow-y:auto;min-height:300px;width:99%;scrollbar-base-color: #F9F9F9;">
					#if($replyList.size()==0)
						<br />
						<h4 align="center">
							暂时没有评论,<a href="javascript:void(0);" onclick="openAddReply();"><font color="blue">$text.get("I.want.reply")</font></a>!
						</h4>
					#end	 
...
<form name="replyform" action="/OANewsAction.do?operation=$globals.getOP("OP_QUERY")&type=addreply" method="post">
...
<div id="addreply" style="display:none;" class="reply_div">
	...
	<textarea id="content" name="content" style="width:97%;height:95px;margin:5px;" onchange="checkMaxInput();"  onkeyup="checkMaxInput();" ></textarea>
	<span class="faceBtn" id="face1" onclick="javascript:$('#content').focus();"><img src="style1/images/face/face.gif"/>添加表情</span>
