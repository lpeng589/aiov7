  ...
  function show(e) {
	...
	if (options.scaleImg) {
			...
			if (width > 1024) {
				...
				$('#zoom_content img').css('width', '1024');
			} else {
			...
			if (height > 900) {
				$('#zoom_content img').css('height', '53%');
			} else if (height > 800) {
				$('#zoom_content img').css('height', '61%');
			
			} else if (height > 700) {
				$('#zoom_content img').css('height', '69%');
			} else if(height>550){
				$('#zoom_content img').css('height', '80%');
			}
		} else {
		  zoom_content.html('');
	}
