...
<input type="hidden" name="operation" id="operation" value='$globals.getOP("OP_ADD")' />
	<div class="wp_dv" >
		<div class="clear x-d">
			<i class="lf">模板名称:</i><input class="lf" type="text" id="templateName" name="name"/>
		</div>
		<div class="clear x-d">
			<i class="lf">日志类型:</i>
			<lable class="l-cbox">
				<input type="radio" name="toplanType" value="day" checked="checked"/> 
				<i>日</i>
			</lable>
			<lable class="l-cbox">
				<input type="radio" name="toplanType" value="week"/> 
				<i>周</i>
			</lable>
		</div>
		<div class="clear x-d">
			<i class="lf">是否启用:</i>
			<lable class="l-cbox">
				<input type="radio"  name="statusId" value="0" checked="checked"/> 
				<i>是</i>
			</lable>
			<lable class="l-cbox">
				<input type="radio"  name="statusId" value="-1"/> 
				<i>否</i>
			</lable>
		</div>
		<!-----------分割线 wp_bk板块 Start------------->
			...
			<div class="bk_c">
				<div class="ddv">
					...
					<div class="slt_woy">
						...
						<div class="woy_lt">
							<select class="slt" size="5" name="deptIdsName" id="deptIdsName" multiple="multiple"></select>
						</div>
						<div class="woy_rt">
					...
					<div class="slt_woy">
						...
						<div class="woy_lt">
							<select class="slt" size="5" id="userIdsName" name="userIdsName" multiple="multiple"></select>
						</div>
						<div class="woy_rt">
		...
		<!-----------分割线 wp_bk板块 End------------->
		<div>
			<textarea name="content" id="content" style="height:230px;width:930px;line-height:normal;"></textarea>
		</div>
	</div>
</form>
