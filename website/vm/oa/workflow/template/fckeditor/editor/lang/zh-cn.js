...
AIOTextField     : "AIO单行文本",
AIOTextarea     : "AIO多行文本",
AIOSelectionField	: "AIO下拉列表",
AIOCheckbox	: "AIO复选框",
AIORadio	: "AIO单选框",
AIOTextFieldProp     : "AIO单行文本属性",
AIOTextareaProp     : "AIO多行文本属性",
AIOSelectionFieldProp	: "AIO下拉列表属性",
AIOCheckboxProp	: "AIO复选框属性",
AIORadioProp	: "AIO单选框属性",
delObj				: "删除",
AIODetail			: "明细表、图片、附件",
AIODetailProp	: "明细表、图片、附件属性"
};
