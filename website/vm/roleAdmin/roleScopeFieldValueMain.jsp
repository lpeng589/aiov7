...
function addmain(){
	...
	asyncbox.open({
 		id:'AddUpdatediv',
		title : '[角色:$!roleName]&nbsp;&nbsp;$!{tableDisplay}查看范围值控制-添加',
...
oDiv.style.height=sHeight+"px";
	...
	<div id="deptRightTypeDiv3" style="padding-left:5px;">
		...
		<ul class="HeadingButton" style="margin:0;">
			<li id="add"  style="display:block;padding:5px 0;" ><button type="button" onClick="addmain();" class="hBtns">$text.get("common.lb.add")</button></li>		
		</ul>
			<table border="0" cellpadding="0" cellspacing="0" class="listRange_list_function" name="table" id="tblSort">
				<thead>
					<tr>
						...
						<td width="150" align="center">范围值</td>
						<td width="150" align="center">范围结束值</td>
