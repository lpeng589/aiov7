...
<div class="Heading">
	...
	<div class="HeadingTitle">$text.get("unitadmin.title.update")</div>
	...
	<div class="listRange_div_jag">
		<div class="listRange_div_jag_div"></div>
			<ul class="listRange_jag">				
				<li><span>$text.get("unit.lb.name")：</span><input name="unitName" type="text" style="width:150px" value="$!result.unitName" maxlength="50">
                    <img src="/$globals.getStylePath()/images/biaozianniu.gif" width="15" height="15"></li>
			     <li><span>$text.get("unit.lb.remark")：</span><input name="remark" type="text" style="width:150px" value="$!result.remark" maxlength="50">
                 </li>
				<li style="margin-top:10px;margin-left:40px; float:left; "><button type="submit" class="b2">$text.get("common.lb.ok")</button><button type="button" onClick="location.href='/UnitQueryAction.do?operation=$globals.getOP("OP_QUERY")'" class="b2">$text.get("common.lb.back")</button></li>
			</ul>
