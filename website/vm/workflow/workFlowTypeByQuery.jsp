...
<title>$text.get("oa.workflow.query")</title>
...
<div class="Heading">
	<div class="HeadingIcon"><img src="/$globals.getStylePath()/images/Left/Icon_1.gif"></div>
		<div class="HeadingTitle">$text.get("oa.workflow.query")</div>
</div>
<div id="listRange_id">
					...
					<ul class="pro_con">
					  <li>
                              <dl class="pro_right">
                                ...
                                <dd><a href="javascript:showreModule('$globals.getTableDisplayName("$flow.TableName")','/UserFunctionQueryAction.do?tableName=$flow.TableName&src=menu');">$globals.getTableDisplayName("$flow.TableName")</a></dd>
                                	#end
                                #end
                                #foreach($file in $tempList)
		                        	#if(1==$LoginBean.id || $globals.canVisit($globals.get($file,5)))
			                        	#if($globals.get($file,4)==$globals.get($pal,0))
			                        		<dd><a href="javascript:showreModule('$globals.get($file,1)','/OAFileWorkFlowAction.do?tempType=$globals.get($file,0)')">
			                        			 $globals.get($file,1)
			                        		</a>
			                        		</dd>
			                        	#end
