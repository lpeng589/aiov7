		...
		this.each(function(i, cont) {
			...
			var newList = {
				...
				dropItem: function() {
					...
					//zxy					
					if(moveObj != null && !changed){ 
						clk = $(moveObj).parent().attr("myclick");							
						if( ! $(moveObj).parent().is("a")){
							clk = $(moveObj).parent().parent().attr("myclick");							
						}						
						eval(clk);						
						moveObj= null; 
					}
					if(hadmoveObj != null){
						$(hadmoveObj).css("cursor", "hand");
					}
					return false;
				},
