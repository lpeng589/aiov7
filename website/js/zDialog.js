 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = '/style/images/alert/'; //图片路径配置
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#f6f6f6;">\
                <a href="javascript:void(0);" class="buttonStyle" id="_ButtonOK_' + this.ID + '">确 定</a>\
                <a href="javascript:void(0);" class="buttonStyle" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '">取 消</a>\
              </div></td>\
          </tr>\
        </table></td>\
