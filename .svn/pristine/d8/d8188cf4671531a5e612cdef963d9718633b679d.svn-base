...
<div>
    ...
    <div id=pageTitle><span>$text.get("import.upload.result") &nbsp; </span>
    <ul class="HeadingButton">	
		<li><button type="button"  class="btn btn-small" onClick="location.href='StockCheckAction.do?operation=6&optype=importPreCheckBill&stockCode=$!stockCode&src=menu&winCurIndex=$!winCurIndex'" class="b2">$text.get("common.lb.back")</button></li>
	</ul>
    <div>
	</div></div>
	<div id="bodyUl">
