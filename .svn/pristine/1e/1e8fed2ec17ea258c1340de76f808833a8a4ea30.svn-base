...
public final class CustomizePYM {
		...
		for (int i = 0, Len = chars.length; i < Len; i++) {
			...
			if (ascii.length() == 0) { // 取ascii时出错
				...
				if (spell == null) {
					...
					retuBuf.append(spell.indexOf(",")>-1?spell.substring(0,spell.indexOf(",")):spell);
	 ...
	 */
	public static String getFirstLetter(String cnStr) {
		if (null == cnStr || "".equals(cnStr.trim())) {
			return cnStr;
		}
	...
	public static void main(String[] args) {
		...
		String str = "深圳市";
		System.out.println("Spell=" + CustomizePYM.getFullSpell(str));
		System.out.println("Spell=" + CustomizePYM.getFirstLetter(str));
