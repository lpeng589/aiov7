		...
		<div id="data_list_id" class="data_list"  style="overflow:hidden;overflow:hidden;width:99%;margin-top: 0px;" >
			...
			oDiv.style.height=sHeight+"px";
				...
				<ul class="dataListUL">
					...
					<li >
						<label style="margin-left: 5px;">弹出窗名字:</label>
						<span>$!popupDesc</span>
					</li>
					<li >
						<label style="margin-left: 5px;">弹出窗标识:</label>
						<span>$!popupName</span>
					</li>					
					<li >
						<label style="margin-left: 5px;">弹出窗路径:</label>
						<span>$!popupPath</span>
					</li>
				
				</ul>	
			#else				
					<span style="font-size: 25px;margin: 30px 0px 0px 150px;display: block;">$!msg</span>
			#end					
		</div>
	</form>
</body>
