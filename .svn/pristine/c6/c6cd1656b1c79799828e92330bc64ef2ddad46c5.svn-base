...
public class SogouSite extends AbstractSearchSite {
	...
	public String doSearch(String keyWord) {
		try {
			return "query=" + java.net.URLEncoder.encode(keyWord, "gbk");
	...
	public String searchURL() {
		return "http://www.sogou.com/web?dr=1&dp=1&_asf=www.sogou.com&_ast=&w=01019900&p=40040100&";
		// return
