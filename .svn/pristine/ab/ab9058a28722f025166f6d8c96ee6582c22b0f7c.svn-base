...
putValidateItem("image","$text.get('crm.deskTop.myHeadportrait')","any","",false,0,250);
...
<div class="Heading">
	...
	<div class="HeadingTitle">$text.get("crm.deskTop.myHeadportrait")</div>
</div>
<div style="width:100%;padding-top:5px; height:auto;float:left; border-top:1px solid #CCCCCC; background:#fff url(/$globals.getStylePath()/images/aiobg.gif) repeat-x left -221px;">
		...
		<div style="padding-left: 50px;padding-top:20px;">
			$text.get("upload.lb.fileName")：<input name="image" class="text" type="file" value="" maxlength="170">
		</div>
