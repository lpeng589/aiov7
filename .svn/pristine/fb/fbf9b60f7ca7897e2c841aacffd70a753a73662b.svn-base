...
<div style="padding-left:60px;">日期：<input name="BillDate" id="BillDate" value="$!values.BillDate" onClick="openInputDate(this);" style="width: 80px;" onChange="dateChange()"/><label style="padding-left:10px;"><span id="span1"></span> 年 第 <span id="span2"></span> 期</label>
...
<table height="30px" border="1" id="tableItem">
  <tr id="titles" name="titles">
    ...
    <img src="/style1/images/workflow/Add.gif" title="插入行" class="img1" id="addrow"/></td>
  ...
  <tr id="copyTr" class="copyTr" row_id="$count">
    ...
    <img src="/style/plan/del_icon.gif" title="删除行" class="img1" onClick="delimg(this,'keyIds')"/>
    </td>
    ...
    <td><input name="AccCodeName" id="AccCodeName" style="width: 100%" onfocus="focusRow(this)" onblur="cl(this);"  
    onkeyup="currencysettings ='$!globals.getSysSetting('currency')'; showData(this,'AccInfoAccDet','AccCodeName','选择科目')"
    ondblclick="selectAccCode(this,'update','$!globals.getSysSetting('currency')')" value="${detailList.AccCode} - $!lstr"
    ...
    #end
    <td><input name="tblAccDetail_DebitCurrencyAmount" id="DebitCurrencyAmount"  onblur="sumMoney(this)" value="$!debitCurrencyAmount" class="moneyposition" onkeyup="showBigNum(this)" onfocus="showBigNum(this);focusRow(this)" disableautocomplete="true" autocomplete="off"/></td>
    ...
    #end
    <td><input name="tblAccDetail_LendCurrencyAmount" id="LendCurrencyAmount"  onblur="sumMoney(this)" value="$!lendCurrencyAmount" class="moneyposition" onkeyup="showBigNum(this)" onfocus="showBigNum(this);focusRow(this)" disableautocomplete="true" autocomplete="off"/></td>
    #end
    #set($debitamount = $!globals.formatNumber($!$detailList.DebitAmount,false,false,true,"tblAccDetail","DebitAmount",true))
    #if($debitamount==0)
    	#set($debitamount = "")
    #end
    <td><input name="tblAccDetail_DebitAmount" id="DebitAmount" onblur="sumMoney(this)" value="$!debitamount" class="moneyposition" onkeyup="showBigNum(this)" onfocus="showBigNum(this);focusRow(this)" disableautocomplete="true" autocomplete="off"/></td>
    #set($lendamount = $!globals.formatNumber($!detailList.LendAmount,false,false,true,"tblAccDetail","LendAmount",true))
    #if($lendamount==0)
    	#set($lendamount = "")
    #end
    <td><input name="tblAccDetail_LendAmount" id="LendAmount" onblur="sumMoney(this)" value="$!lendamount" class="moneyposition" onkeyup="showBigNum(this)" onfocus="showBigNum(this);focusRow(this)" disableautocomplete="true" autocomplete="off"/></td>
  </tr>
  #set($count=$count+1)
  #end
...
<div class="ABK_Add c_main winw1200 f_l mains divs" style="width:100%;height: 30px;padding: 5px 0px 5px 0px;margin-top: 5px;" id="divemp">
	...
	<li>
		...
		<img style='padding-left:10px;' src='/style1/images/St.gif' onClick="selectPops(this,'SelectAccDepartment','DepartmentName','mDepartmentCode','选择部门')" alt='选择部门' class='search'/>
	</li>
	<li>
		<span>经手人：</span>
		...
		<img style='padding-left:10px;' src='/style1/images/St.gif' onClick="selectPops(this,'SelectAccEmployee','EmployeeName','EmployeeID','选择经手人')" alt='选择经手人' class='search'/>
	</li>
