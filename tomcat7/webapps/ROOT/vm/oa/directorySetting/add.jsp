...
<meta name="renderer" content="webkit">		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		...
		<link type="text/css" rel="stylesheet"
			href="/$globals.getStylePath()/css/ListRange.css" />
		<link type="text/css" rel="stylesheet"
		...
		<script language="javascript" charset="utf-8"
			src="/js/lang/${globals.getLocale()}.js"></script>
...
function fillData(datas){
	...
	<body>
		<form #if("$isRoot" == 1) action="/DirectorySettingNetDiskQueryAction.do?operation=$globals.getOP('OP_ADD')&isRoot=$!isRoot"
			#else action="/DirectorySettingAlbumQueryAction.do?operation=$globals.getOP('OP_ADD')&isRoot=$!isRoot" #end onSubmit="return checkForm();" name="form" method="post">
			<input type="hidden" name="shareuserId" id="popedomUserIds" value="1," />
			<input type="hidden" name="shareDeptOfClassCode" id="popedomDeptIds" value="" />
			<input type="hidden" name="shareEmpGroup" id="EmpGroupId" value="" />
			<input type="hidden" name="downLoadUserId" id="downLoadUserId" value="1," />
			<input type="hidden" name="downLoadDeptOfClassCode" id="downLoadDeptOfClassCode" value="" />
			<input type="hidden" name="downLoadEmpGroup" id="downLoadEmpGroup" value="" />
								...
								<li style="height: 400px;">
									<table style="width:100%; border:0px solid red;">
										<tr style="height:130px;">
											<td bgcolor="#F5F5F5" style="width:10%;">
												目录授权：
											...
											<td width="90%">
												<div
													style="width:28%; height:100px; float:left;margin-left:30px;margin-top:-0px;">
													<div style="width:200px;">
														<span style="float:left;"><img
																src="/style1/images/St.gif"
																onClick="deptPop('deptGroup','formatDeptName','popedomDeptIds','1');"
																class="search" />
														</span>
														<span
															style="float:left; margin-top:-20px;font-size:12px;height:25px;width:200px;"><a
															href="javascript:void(0);"
															onClick="deptPop('deptGroup','formatDeptName','popedomDeptIds','1');"
															style="color:blue;">选择部门</a>
														</span>
													</div>

													<select name="formatDeptName" id="formatDeptName"
														style="width:100px; float:left; margin-top:-15px; "
														multiple="multiple">

													</select>
													<div style="width:30px;margin-top:-15px;">
														<img
															onClick="deleteOpation('formatDeptName','shareDeptOfClassCode')"
															src="/$globals.getStylePath()/images/delete_button.gif"
															alt="$text.get(" oa.common.clear")" title="$text.get("
															oa.common.clear")" class="search" />
													</div>
												</div>
												<div style="width:28%; height:100px; float:left;margin-left:30px;margin-top:0px;">
													<div style="width:200px;">
														...
														<span
															...
															onClick="deptPop('userGroup','formatFileName','popedomUserIds','1');">选择个人</a>
														</span>
													</div>
													...
													<div style="width:30px;margin-top:-15px;">
														<img
															onClick="deleteOpation('formatFileName','shareuserId')"
															src="/$globals.getStylePath()/images/delete_button.gif"
															alt="$text.get(" oa.common.clear")" title="$text.get("
															oa.common.clear")" class="search" />
													</div>
												...
												<div style="color: gray;width:230px;margin-top:-10px;">
													注:若不选，所有人可见此目录信息。
										...
										<tr style="height:130px;">
											...
											<td>
												<div
													...
													<div style="width:200px;">
														<span style="float:left;"><img
																src="/style1/images/St.gif" class="search"
																onClick="deptPop('deptGroup','formatDeptName1','downLoadDeptOfClassCode','1');" />
														</span>
														<span
															style="float:left; margin-top:-20px;font-size:12px;height:25px;width:200px;"><a
															href="javascript:void(0);"
													...
													<select name="formatDeptName1" id="formatDeptName1"
														style="width:100px; float:left; margin-top:-15px; "
														multiple="multiple">
													...
													<div style="width:30px;margin-top:-15px;">
														<img
															onClick="deleteOpation('formatDeptName1','downLoadDeptOfClassCode');"
															src="/$globals.getStylePath()/images/delete_button.gif"
															alt="$text.get(" oa.common.clear")" title="$text.get("
															oa.common.clear")" class="search" />
													</div>
												...
												<div style="width:28%; height:100px; float:left;margin-left:30px;margin-top:0px;">
													<div style="width:200px;">
														<span style="float:left;"><img
																src="/style1/images/St.gif" class="search"
																onClick="deptPop('userGroup','formatFileName1','downLoadUserId','1');" />
														</span>
														<span
															style="float:left; margin-top:-20px;font-size:12px;height:25px;width:200px;"><a
															href="javascript:void(0);"
															onClick="deptPop('userGroup','formatFileName1','downLoadUserId','1');"
															style="color:blue;">选择个人</a>
														</span>
													</div>
													<select name="formatFileName1" id="formatFileName1"
														style="width:100px; float:left; margin-top:-15px; "
														multiple="multiple">
														<option value="1">
															admin
													...
													<div style="width:30px;margin-top:-15px;">
														<img
															onClick="deleteOpation('formatFileName1','downLoadUserId');"
															src="/$globals.getStylePath()/images/delete_button.gif"
															alt="$text.get(" oa.common.clear")" title="$text.get("
															oa.common.clear")" class="search" />
													</div>
												...
												<div
													...
													<div style="width:200px;">
														<span style="float:left;"><img
																src="/style1/images/St.gif" class="search"
																onClick="deptPop('empGroup','EmpGroup1','downLoadEmpGroup','1');" />
														</span>
														<span
															style="float:left; margin-top:-20px;font-size:12px;height:25px;width:200px;"><a
															href="javascript:void(0);"
													...
													<select name="EmpGroup1" id="EmpGroup1"
														style="width:100px; float:left; margin-top:-15px; "
														multiple="multiple">
													...
													<div style="width:30px;margin-top:-15px;">
														<img
															onClick="deleteOpation('EmpGroup1','downLoadEmpGroup');"
															src="/$globals.getStylePath()/images/delete_button.gif"
															alt="$text.get(" oa.common.clear")" title="$text.get("
															oa.common.clear")" class="search" />
													</div>
										...
										<tr style="height:50px;">
											...
											<td>
												<div style="align:center; margin-left:30px;width:80%;">
													<input type="text" style="width:297px;" value="" id="name"
														name="name" onblur="isExistName(0)" />
												</div>
											</td>
										</tr>
										...
										<tr style="height:50px;">
											...
											<td>
												<div style="width:100%;float:left; margin-top:10px;margin-left:30px;">
													<input type="text" style="width:297px;" value="" id="path"
														name="path" onblur="isExistPath(0)" />
													<div id="showErrInfo"
														style="color: red; width:240px; margin-left:10px;margin-top:0px;display: none;">
														请填写正确路径，可参照路径说明!
													</div>
												</div>
												<b style="width:100%px;float:left;margin-left:30px;">路径说明："F:\我的文件夹\2012年文件"与"F:/我的文件夹/2012年文件"为同一路径，不能创建相同路径的目录"</b>
											</td>
										</tr>
									</table>
								</li>
