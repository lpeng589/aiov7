...
FCKCommands.GetCommand = function( commandName )
{
	...
	switch ( commandName )
	{
		...
		case 'delObj'		: oCommand=new FCKDelObjCommand();break;
		...
		case 'AIOCheckbox':oCommand=new FCKDialogCommand('AIOCheckbox',FCKLang.AIOCheckbox,'dialog/fck_aiocheckbox.html',380,200); break;
		case 'Checkbox'		: oCommand = new FCKDialogCommand( 'Checkbox'	, FCKLang.Checkbox		, 'dialog/fck_checkbox.html'	, 380, 200 ) ; break ;
		case 'AIORadio':oCommand=new FCKDialogCommand('AIORadio',FCKLang.AIORadio,'dialog/fck_aioradiobutton.html',380,200); break;
		case 'Radio'		: oCommand = new FCKDialogCommand( 'Radio'		, FCKLang.RadioButton	, 'dialog/fck_radiobutton.html'	, 380, 200 ) ; break ;
		case 'AIOTextField':oCommand=new FCKDialogCommand('AIOTextField',FCKLang.AIOTextField,'dialog/fck_aiotextfield.html',380,210); break;
		case 'TextField'	: oCommand = new FCKDialogCommand( 'TextField'	, FCKLang.TextField		, 'dialog/fck_textfield.html'	, 380, 210 ) ; break ;
		case 'AIOTextarea':oCommand=new FCKDialogCommand('AIOTextarea',FCKLang.AIOTextarea,'dialog/fck_aiotextarea.html',380,210);break;
		case 'AIODetail':oCommand=new FCKDialogCommand('AIODetail',FCKLang.AIODetail,'dialog/fck_aiodetail.html',380,210);break;
		...
		case 'AIOSelect':oCommand=new FCKDialogCommand('AIOSelect',FCKLang.AIOSelectionField,'dialog/fck_aioselect.html',380,210);break;
