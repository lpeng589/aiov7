...
BillNoFieldProp     : "单据编号属性",
AIOTextFieldProp     : "AIO单行文本属性",
AIOTextareaProp     : "AIO多行文本属性",
RepeatFieldProp     : "去重复控件属性",
TextFieldProp		: "单行文本属性",
AIOSelectionFieldProp	: "AIO下拉列表属性",
SelectionFieldProp	: "下拉列表属性",
TextareaProp		: "多行文本属性",
DateFieldProp		: "日期控件属性",
HongFieldProp		: "宏控件属性",
CountFieldProp		: "计算控件属性",
AffixFieldProp		: "图片/附件属性",
EmployeeFieldProp	: "人员弹出窗属性",
DeptFieldProp		: "部门弹出窗属性",
ClientFieldProp		: "客户弹出窗属性",
PopupFieldProp 		: "定制弹出窗属性",
...
DlgTextName			: "控件名称",
DlgTextValue		: "初始值",
DlgTextCharWidth	: "控件宽度",
DlgTextMaxChars		: "最多字符数",
DlgTextType			: "类型",
DlgTextTypeText		: "文本",
DlgTextTypePass		: "密码",
DlgTextDateType		: "日期输入格式",
