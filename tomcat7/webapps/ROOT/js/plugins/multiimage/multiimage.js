...
K.extend(KSWFUpload, {
	init : function(options) {
		...
		var settings = {
			...
			upload_success_handler : function(file, serverData) {
				...
				K('.ke-img', itemDiv).attr('src', file.url).attr('data-status', file.filestatus).attr('onclick',"mj");
				K('.ke-status > div', itemDiv).hide();
			}
		};
	...
	appendFile : function(file) {
		...
		var imgs = '<img src="' + file.url + '"   class="ke-img" data-status="' + file.filestatus + '" width="80" height="80" alt="' + file.name + '" />';
...
KindEditor.plugin('multiimage', function(K) {
	...
	var self = this, name = 'multiimage',
		...
		imageSizeLimit = K.undef(self.imageSizeLimit, '20MB'),//mj
		imageFileTypes = K.undef(self.imageFileTypes, '*.jpg;*.gif;*.png;*jpeg;*png;*bmp;'),//mj
