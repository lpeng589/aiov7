...
//	 [8][4][16]
	...
	**************************************************************************/
	...
	public String Encode(String strDefaultKey,String str) {
	   int i1;
	...
	public String Decode(String strDefaultKey,String str) {
	   int i2;

	   byte[] byteMingW = new byte[1024*1024]; // 密文
	   byte[] byteMiW = new byte[1024*1024];
