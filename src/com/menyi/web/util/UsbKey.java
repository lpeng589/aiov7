...
public class UsbKey {
    ...
    public static String keyId="1234567890ABCDEF1234567890ABCDEF";
    ...
    private static String myhex(byte indata) {
        String outstring;
        outstring = Integer.toHexString(indata & 255);
    ...
    public static String StrEnc(String InString, String Key) { //使用增强算法，加密字符串
    ...
    public static void EnCode(byte[] inb, byte[] outb, String Key) {
