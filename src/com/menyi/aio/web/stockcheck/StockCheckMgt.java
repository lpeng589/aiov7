			...
			public int exec(Session session) {
				session.doWork(new Work() {
					public void execute(Connection conn) throws SQLException {
						try {
							Statement cs = conn.createStatement();
							StringBuffer sql = new StringBuffer("select tblGoods.classCode,tblGoods.GoodsNumber,tblGoods.GoodsFullName,tblGoods.GoodsSpec,tblGoods.BaseUnit,checkgoods.BatchNo,");
