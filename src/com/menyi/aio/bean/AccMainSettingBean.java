 ...
 */
@Entity
@Table(name = "tblAccMainSetting")
public class AccMainSettingBean {

	
	@Id
    @Column(nullable=false,length=30)
    private String id;									//id
	private Integer isAuditing;							//启用审核(0否-默认，1启用)
	private Integer isCheck;							//凭证过账前必须出纳复核（0否-默认，1启用）
	private Integer isCash;								//录入凭证时必须指定现金流量（0否-默认，1启用）
	private Integer isAccountAuditing;					//凭证过账前必须审核（0否-默认，1启用）
	private String auditingPersont;						//审核人
	private String reverseAuditing;						//反审核人
	private String binderPersont;						//过账人
	private String reverseBinder;						//反过账人
	private String checkPersont;						//复核人
	private String cashPersont;							//指定现金流量人
